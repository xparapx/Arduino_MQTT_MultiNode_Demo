...
const AQ = (() => {
  ...
  const ICONS = {
    ...
    monitor: '<rect x="2.5" y="3.5" width="19" height="13.5" rx="2"/><line x1="12" y1="17" x2="12" y2="20.5"/><line x1="8" y1="20.5" x2="16" y2="20.5"/><line x1="6.5" y1="14" x2="6.5" y2="11.5"/><line x1="9.5" y1="14" x2="9.5" y2="9"/><polyline points="12.5,13 15,9.5 17,11.5 19.5,7.5"/>',
    alertgear: '<circle cx="9.5" cy="9" r="3"/><path d="M9.5 3.2v2.1M9.5 12.7v2.1M3.7 9h2.1M13.2 9h2.1M5.4 4.9l1.5 1.5M12.1 12.6l1.5 1.5M13.6 4.9l-1.5 1.5M6.9 12.6l-1.5 1.5"/><path d="M16.8 12.4l4.5 7.8h-9z"/><line x1="16.8" y1="15.5" x2="16.8" y2="17.3"/><line x1="16.8" y1="18.9" x2="16.8" y2="18.95"/>',
  ...
  function devChip(d) {
    ...
    if (d.output) return `<span class="fanchip idle" data-tip="통전 · 대기전력 ${w}">${fan}대기 ${w}</span>`;
    return `<span class="fanchip off" data-tip="플러그 전원 차단(릴레이 열림)">${fan}OFF</span>`;
  }

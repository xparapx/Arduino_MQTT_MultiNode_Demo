...
- **점검 결과**: CLASS_01 환경노드는 수집 정상(24h 277행) — 화면 "제외"는 QC "CO₂ 유효 93.9% < 95%"(SCD30 일부 무효값). 실제 멈춘 노드는 **CLASS_06(node_E04537, 09-14 23:05 UTC~)**이고, 같은 시각 유령 `node_000500` 2행(id 148766·148774) 출현 — 재부팅 시 쓰레기 MAC(09-10 진단 유형). 전원 재인가 필요.

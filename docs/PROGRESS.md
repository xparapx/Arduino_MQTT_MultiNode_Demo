...
- [ ] 노드 선택 시 전체 깜빡임 없음 — 사용자 확인 대기
- [ ] 화면 구성·색·순서 동일 — 사용자 확인 대기 (의도된 차이: ② "last 28 days" 캡션, ⑤ Prepare 버튼, 이상치/과거점 표본화)

[ASK] 결정: 28일 창 채택 · 태블릿 체감 측정은 LED 인디케이터 부착·학생 수행 이후로 연기 · WAL 전환 미결 · 레이더 8개 → 폴라 서브플롯 1 figure (a)는 Phase 5.
